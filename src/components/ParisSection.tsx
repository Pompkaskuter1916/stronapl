        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-16 mt-12 relative">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 font-serif leading-[1.8]">
              Każda ulica, latarnia czy kiosk ma swoje miejsce i funkcję. Budynki są tu wznoszone z rozmachem, który zdaje się nie kosztować mieszkańców wysiłku – siła ludzka pracuje tu „jakby dla rozrywki”, tworząc monumentalne gmachu pełne ozdób.
            </p>
          </motion.div>
